...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sagetex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7392&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sagetex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sagetex` can be installed with:

```
conda install sagetex
```

It is possible to list all of the versions of `sagetex` available on your platform with:
